<template>
  <div class="card shadowborder-dark mx-auto" style="overflow: auto; min-width: 150px; max-width: 500px;"  v-if="recipeData && nutritionData">
    <div class="card-header"><h3 style="font-size: 2.5vw;">Breakfast</h3></div> 
