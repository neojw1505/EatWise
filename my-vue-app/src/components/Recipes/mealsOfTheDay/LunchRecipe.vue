<!-- This component generates one or more random lunch recipes -->
<template>
  <div>
    <button @click="getLunchRecipe">get Lunch Recipe</button>
    <div v-if="LunchRecipe">
...
export default {
  data() {
    return {
      LunchRecipe: null,
      // list of categories to include as Lunch
  ...
  methods: {
    async getLunchRecipe() {
      ...
      this.RecipeID = this.LunchRecipe.id;
      this.Title = this.LunchRecipe.title;
      this.imgURL = this.LunchRecipe.image;
